                ...
                <div className="container py-sm-4">
                    <div className="row">
                        ...
                        <div className="col-lg-6 roomsingle mt-lg-0 mt-4">
                            <h3 className="title-small">Deluxe Rooms (AC)</h3>
                            <p className="roomsingle mt-3">Spaciously built and elegantly furnished, Deluxe Rooms come with air conditioning and are the perfect retreat for two adults. The rooms are equipped with comfortable queen-sized beds, free wi-fi, televisions and a host of other modern conveniences to make you feel at home. Our rooms have large windows overlooking the Bannerghatta National Park so that you never miss a glimpse of the nature outside.<br />Each room can accommodate 2 adults and 1 child.
                    ...
                    <div className="row">
                        <div className="col-lg-7 roomsingle">
                            ...
                            <ul className="w3l-right-book mt-4">
                                <li><a hef="#url"><span className="fa fa-check" aria-hidden="true"></span>Air Conditioning</a></li>
                                <li><a hef="#url"><span className="fa fa-check" aria-hidden="true"></span>Television</a></li>
                                <li><a hef="#url"><span className="fa fa-check" aria-hidden="true"></span>Wardrobe
                                </a></li>
